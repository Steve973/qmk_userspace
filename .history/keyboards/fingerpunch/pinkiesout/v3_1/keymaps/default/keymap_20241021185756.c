...
#include "keyboards/fingerpunch/src/fp_joystick.h"
...
const js_rgb_layer_t js_rgb_layers_instance = {
    .rgb_step_and_val_layer = _LOWER,
    .rgb_sat_and_hue_layer = _RAISE,
    .rgb_toggle_and_speed_layer = _ADJUST,
};
